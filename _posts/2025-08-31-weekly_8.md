...
- YOLOv1의 한계
Grid를 나눈 각 Cell마다 Bounding Box의 수가 B개로 정해져 있다는 것입니다. Bounding Box가 적으면 RoI가 적어지게 되고, 그에 따라 Object 탐지 능력이 떨어지게 됩니다. 이로 인해, 하나의 Cell에 여러 개의 object가 겹치면 하나의 Object만 탐지한다는 단점이 있습니다.
<br>
