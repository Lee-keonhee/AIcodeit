...
<table>
    <tr>
        <td width="50%" valign="top">
            <img src="{{"/assets/images/CNN_architecture.png" | relative_url }}" width="400" height="300" alt="cat_segmentation" style="display: block; margin: 0 auto;">
            <p style="text-align: center; margin-top: 10px; font-weight: bold;">[그림] CNN 분류 구조 다이어그램: 입력 → Conv/Pooling 반복 → FC → Class</p>
        </td>
        <td width="50%" valign="top">
            <img src="{{"/assets/images/FCN_architecture.png" | relative_url }}" width="400" height="300" alt="cat_segmentation" style="display: block; margin: 0 auto;">
